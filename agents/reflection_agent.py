...
from utils.completions import build_prompt_structure, completions_create, FixedFirstChatHistory, update_chat_history
...
user_msg = " Hi I am Anjum from kerala. what is 10 cross 10. Tell me as a linear algebra speacialist"

print(agent.run(user_msg, verbose = 1))
